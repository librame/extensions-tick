...
{
    class InternalWatermarkDrawableProcessor : AbstractDrawableProcessor, IWatermarkDrawableProcessor
    {
        ...
        public InternalWatermarkDrawableProcessor(DrawingExtensionOptions options)
            : base(options)
        {
        ...
        {
            if (Options.Watermark.Mode == WatermarkMode.Image && _watermarkBitmap != null)
            {
