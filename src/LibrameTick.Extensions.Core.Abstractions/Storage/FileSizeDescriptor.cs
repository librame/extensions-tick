...
namespace Librame.Extensions.Core.Storage
{
    ...
    public class FileSizeDescriptor
    {
        ...
        public FileSizeDescriptor(string name, string abbr, int baseNumber, int exponent)
            : this(name, abbr)
        {
        ...
        public FileSizeDescriptor(string name, string abbr, long size)
            : this(name, abbr)
        {
            Size = size;
        }

        private FileSizeDescriptor(string name, string abbr)
        {
