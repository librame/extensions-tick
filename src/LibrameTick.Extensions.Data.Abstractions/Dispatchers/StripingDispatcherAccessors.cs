...
/// </summary>
public class StripingDispatcherAccessors : BaseDispatcherAccessors
{
    /// <summary>
    /// 构造一个 <see cref="StripingDispatcherAccessors"/>。
    /// </summary>
    /// <param name="accessors">给定的 <see cref="IEnumerable{IAccessor}"/>。</param>
    /// <param name="factory">给定的 <see cref="IDispatcherFactory"/>。</param>
    public StripingDispatcherAccessors(IEnumerable<IAccessor> accessors,
    ...
    protected StripingDispatcherAccessors(IEnumerable<IAccessor> accessors,
