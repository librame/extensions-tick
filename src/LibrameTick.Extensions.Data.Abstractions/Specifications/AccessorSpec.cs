...
/// <summary>
/// 定义一个实现 <see cref="AbstractSpec{IAccessor}"/> 的数据访问存取器规约。
/// </summary>
public class AccessorSpec : AbstractSpec<IAccessor>
{
    /// <summary>
    /// 构造一个 <see cref="AccessorSpec"/>。
    /// </summary>
    /// <param name="group">给定的分组。</param>
    /// <param name="access">给定的 <see cref="AccessMode"/>。</param>
    public AccessorSpec(int group, AccessMode access)
    {
        Access = access;
        Group = group;
    }
