...
/// 定义分片策略参数。
/// </summary>
public class ShardedStrategyParameter<TValue>
{
    /// <summary>
    /// 默认键指示符。
    /// </summary>
    ...
    /// <summary>
    /// 构造一个 <see cref="ShardedStrategyParameter{TValue}"/>。
    /// </summary>
    ...
    public ShardedStrategyParameter(string name, Func<TValue, string> valueFormatter,
