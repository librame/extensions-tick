...
/// </remarks>
public class DateTimeOffsetShardingStrategy : AbstractShardingStrategy
{
    private readonly Dictionary<string, Func<DateTimeOffset, string>> _parameters = new()
    {
    ...
    public DateTimeOffsetShardingStrategy(IClockBootstrap clock)
    {
        Clock = clock;
    }
