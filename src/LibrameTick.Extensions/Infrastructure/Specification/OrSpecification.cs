...
/// <summary>
/// 定义实现 <see cref="AbstractSpecification{T}"/> 的或复合规约。
/// </summary>
/// <typeparam name="T">指定的类型。</typeparam>
/// <remarks>
/// 构造一个 <see cref="OrSpecification{T}"/> 实例。
/// </remarks>
/// <param name="left">给定的 <see cref="ISpecification{T}"/> 左实例。</param>
/// <param name="right">给定的 <see cref="ISpecification{T}"/> 右实例。</param>
public class OrSpecification<T>(ISpecification<T> left, ISpecification<T> right) : AbstractSpecification<T>
{
