...
/// </summary>
public class SnowflakeIdGenerator : AbstractIdGenerator<long>
{
    private readonly IClockBootstrap _clock;
    private readonly ILockerBootstrap _locker;
    private readonly SnowflakeIdParameters _parameters;
    ...
    /// <param name="parameters">给定的 <see cref="SnowflakeIdParameters"/>（可选）。</param>
    public SnowflakeIdGenerator(IClockBootstrap clock, ILockerBootstrap locker,
        IdGenerationOptions options, SnowflakeIdParameters? parameters = null)
    {
        _clock = clock;
        _locker = locker;
        _parameters = parameters ?? new SnowflakeIdParameters();
