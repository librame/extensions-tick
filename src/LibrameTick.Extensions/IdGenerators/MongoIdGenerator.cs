...
/// </summary>
public class MongoIdGenerator : AbstractIdGenerator<string>
{
    ...
    public MongoIdGenerator(IClockBootstrap clock)
    {
        _clock = clock;
    ...
    private string GenerateId(out MongoIdParameters result)
    {
        result = new MongoIdParameters(GetTimestampBytes());
