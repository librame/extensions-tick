...
public class CompositeDispatcher<TSource> : BaseDispatcher<TSource>, IComposable<IDispatcher<TSource>>
    where TSource : IEquatable<TSource>
{
    private IEnumerable<IDispatcher<TSource>> _dispatchers;
        ...
        : base(dispatchers.SelectMany(s => s), DispatchingMode.Striping, options)
    {
        ...
        DispatchersCount = dispatchers.Count();
    }
    ...
    /// 调度器集合数。
    /// </summary>
    public int DispatchersCount { get; init; }
