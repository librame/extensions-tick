...
public class ProxyDecorator<TInterface> : IProxyDecorator<TInterface>
{
    /// <summary>
    ...
    public ProxyDecorator(TInterface proxySource, IInterceptor interceptor)
    {
    ...
    /// 代理来源复合实例。
    /// </summary>
    public TInterface ProxySource { get; init; }
