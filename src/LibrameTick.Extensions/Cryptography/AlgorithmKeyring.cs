...
/// </summary>
public sealed class AlgorithmKeyring : AbstractKeyingId
{
    /// <summary>
    /// HMAC HASH 密钥环。
    /// </summary>
    ...
    /// </summary>
    [JsonIgnore]
    public AsymmetricCertificatePair? Rsa { get; set; }

    /// <summary>
    /// ECDSA 数字证书对。
    /// </summary>
    [JsonIgnore]
    public AsymmetricCertificatePair? Ecdsa { get; set; }


    /// <summary>
    /// 获取必需的 RSA 数字证书对。
    /// </summary>
    /// <returns>返回 <see cref="AsymmetricCertificatePair"/>。</returns>
    /// <exception cref="ArgumentNullException">
    /// <see cref="Rsa"/> is null.
    /// </exception>
    public AsymmetricCertificatePair GetRequiredRsa()
    {
        var rsa = Rsa;
    ...
    /// <returns>返回 <see cref="AsymmetricCertificatePair"/>。</returns>
    /// <exception cref="ArgumentNullException">
    /// <see cref="Ecdsa"/> is null.
    /// </exception>
    public AsymmetricCertificatePair GetRequiredEcdsa()
    {
        var ecdsa = Ecdsa;
        ArgumentNullException.ThrowIfNull(ecdsa, nameof(Ecdsa));
    ...
    public void PopulateAll(string id,
    ...
    public void PopulateAll(AlgorithmKeyring keyring)
    {
        Id = keyring.Id;
