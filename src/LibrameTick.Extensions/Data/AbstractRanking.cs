...
namespace Librame.Extensions.Data
{
        ...
        where TRank : struct
    {
        ...
        /// 排名。
        /// </summary>
        [Display(Name = nameof(Rank), GroupName = "DataGroup")]
        ...
        public virtual ValueTask<object> GetObjectRankAsync(CancellationToken cancellationToken)
            => Task.Run(GetObjectRank, cancellationToken).AsValueTask();
        ...
        {
            Rank = newRank.AsIfNotNull<TRank>(nameof(newRank));
            return newRank;
        }
        ...
        {
            var realNewRank = newRank.AsIfNotNull<TRank>(nameof(newRank));
