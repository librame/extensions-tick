...
/// <summary>
/// 定义继承 <see cref="FilePersistenceProvider{TPersistence}"/> 的 JSON 文件持久化提供程序。
/// </summary>
...
public class JsonFilePersistenceProvider<TPersistence>(bool isWatching, string filePath, Encoding? encoding, Func<TPersistence> initialFunc)
    : FilePersistenceProvider<TPersistence>(isWatching, filePath, encoding, initialFunc)
{
    /// <summary>
